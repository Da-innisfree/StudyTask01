...
<body>
	...
	<div class="container">
		<form class="form-floating" action="/crizen/updateBoard.do"
			method="post">
			<input type="hidden" name="bno" value="${thisBoard.bno }">
			<div>
				<label for="floatingInputValue">제목</label> <input type="text"
					class="form-control" id="floatingInputValue" name="title"
					value="${thisBoard.title }">
			</div>
			<div>
				<label for="floatingInputValue">작성자</label> <input type="text"
					class="form-control" id="floatingInputValue" name="writer"
					value="${thisBoard.writer }" readonly="readonly">
			</div>
			<div>
				<label for="floatingInputValue">작성 일시</label> <input type="text"
					class="form-control" id="floatingInputValue" name="regDate"
					value="${thisBoard.regDate }" readonly="readonly">
			</div>
			<div>
				<label for="floatingInputValue">수정자</label> <input type="text"
					class="form-control" id="floatingInputValue" name="editor"
					value='<sec:authentication property="principal.username"/>'
					readonly="readonly">
			</div>
			<div class="form-floating">
				<textarea class="form-control" placeholder="Leave a comment here"
					id="floatingTextarea3" name="context" style="height: 200px"><c:out
